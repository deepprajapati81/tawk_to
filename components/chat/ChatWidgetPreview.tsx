  ...
  export const ChatWidgetPreview = ({ config }: Props) => {
    const { title, color, message, suggestions, userMessages,fontFamily } = config;
    ...
    return (
      <Card className={`w-full max-w-lg h-130 rounded-xl flex flex-col overflow-x-hidden shadow-lg gap-0 py-0 `} style={{fontFamily: fontFamily }}>       {/* for font family*/}
        <div
