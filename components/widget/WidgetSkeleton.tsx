...
export const WidgetSkeleton = () => {
  return (
    <Card className="xl:w-[80%] md:w-[70%] w-full max-w-lg h-130 rounded-xl flex flex-col overflow-hidden shadow-lg animate-pulse">
      {/* Header Skeleton */}
      <div className="flex items-center px-4 py-3 bg-gray-300">
        <div className="w-6 h-6 bg-gray-400 rounded"></div>
        <div className="ml-2 w-32 h-5 bg-gray-400 rounded"></div>
      </div>
    ...
    <Card className="xl:w-[80%] md:w-[70%] w-full max-w-lg h-130 rounded-xl flex flex-col overflow-hidden shadow-lg relative">
      ...
      <div className="flex-1 px-3 py-4 space-y-3 bg-white">
        ...
        <div className="flex flex-col items-end space-y-2">
          <div className="relative overflow-hidden">
            <div className="w-48 h-10 bg-gray-200 rounded-md"></div>
            <div className="absolute inset-0 -translate-x-full animate-shimmer-fast bg-linear-to-r from-transparent via-white/40 to-transparent" style={{ animationDelay: '0.1s' }}></div>
          </div>
          <div className="relative overflow-hidden">
            <div className="w-40 h-10 bg-gray-200 rounded-md"></div>
            <div className="absolute inset-0 -translate-x-full animate-shimmer-fast bg-linear-to-r from-transparent via-white/40 to-transparent" style={{ animationDelay: '0.2s' }}></div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end space-y-2 mt-4">
          <div className="relative overflow-hidden">
            <div className="w-56 h-10 bg-gray-200 rounded-md"></div>
            <div className="absolute inset-0 -translate-x-full animate-shimmer-fast bg-linear-to-r from-transparent via-white/40 to-transparent" style={{ animationDelay: '0.3s' }}></div>
          </div>
        </div>
      </div>
